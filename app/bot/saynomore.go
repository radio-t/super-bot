...
func NewDefaultSayNoMore(superUser SuperUser) *SayNoMore {
	return NewSayNoMore(1*time.Hour, 12*time.Hour, superUser, []SayNoMoreCategory{
		...
		{
			Words:     []string{"ньюанс", "ньюанса", "ньюансу", "ньюансом", "ньюансе", "ньюансы", "ньюансов", "ньюансам", "ньюансами", "ньюансах"},
			Responses: []string{"Полиция Нью-Ансов уже выехала", "Корреспондент из Нью-Ансов подтверждает бан", "В Нью-Ансах за такие слова исчезают", "Добро пожаловать в Нью-Ансы", "Новости Нью-Ансов: нарушитель изолирован", "В Нью-Ансах объявлен режим чистого чата"},
		},
	})
}

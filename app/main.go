...
var opts struct {
	...
	OpenAI struct {
		...
		ReasoningEffort   string `long:"reasoning-effort" env:"REASONING_EFFORT" default:"" description:"OpenAI reasoning_effort for reasoning models (minimal, low, medium, high)"`
